...
class ApiResponseTest {
    ...
    fun exception() {
        ...
        assertThat<String>(errorMessage, `is`("Bad Request"))
    }

    @Test
    fun success() {
        val apiResponse: ApiSuccessResponse<String> = ApiResponse
            .create<String>(Response.success("DataList")) as ApiSuccessResponse<String>
        assertThat<String>(apiResponse.body, `is`("DataList"))
    }
